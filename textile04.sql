...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 11 2025 г., 03:02
...
CREATE TABLE `location` (
  `id` int NOT NULL,
  `row_number` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `shelf_number` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `obrezki` (`id`, `prod_mat_id`, `length`, `width`, `remainder`, `creation_date`, `is_used`) VALUES
(1, 1, '0.50', '1.50', '0.50', '2025-02-13', 0),
(2, 2, '0.70', '2.00', '0.70', '2025-02-13', 0),
(3, 1, '1.50', '0.00', '100.00', '2025-02-13', 0),
(4, 2, '2.00', '0.00', '50.00', '2025-02-13', 0),
(5, 3, '0.00', '0.00', '200.00', '2025-02-13', 0);
...
(1, 1, 1, 10, '1.50', '2.00', 1, '5000.00', 'В производстве', NULL, NULL, NULL),
(2, 1, 2, 20, '0.70', '1.40', 2, '10000.00', 'В производстве', NULL, NULL, NULL),
(3, 2, 3, 5, '1.50', '1.50', 1, '2500.00', 'В производстве', NULL, NULL, NULL);
...
CREATE TABLE `order_request` (
  ...
  `status` enum('Новый','В обработке','В производстве','Выполнен','Отменен') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'Новый',
...
CREATE TABLE `product` (
  ...
  `unit_of_measure_id` int NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `product_materials` (`id`, `order_composition_id`, `supply_composition_id`, `quantity`, `cost`) VALUES
(1, 1, 1, 15, NULL),
(2, 2, 2, 10, NULL),
(3, 3, 3, 8, NULL);
...
CREATE TABLE `warehouse_movement` (
  ...
  `supply_id` int DEFAULT NULL,
  `location_id` int DEFAULT NULL,
  `movement_type` enum('Приход','Расход') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `width` decimal(10,2) DEFAULT NULL,
  `length` decimal(10,2) DEFAULT NULL,
  `creation_date` date NOT NULL,
...
ALTER TABLE `obrezki`
  ADD PRIMARY KEY (`id`),
  ADD KEY `material_id` (`prod_mat_id`);
...
--
ALTER TABLE `obrezki`
  ADD CONSTRAINT `obrezki_ibfk_1` FOREIGN KEY (`prod_mat_id`) REFERENCES `product_materials` (`id`);
